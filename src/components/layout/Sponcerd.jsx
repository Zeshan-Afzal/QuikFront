...
const Sponcerd = () => {
  return (
    <div
      className={` w-[90%] hidden sm:block bg-white py-10 px-5 mb-12 cursor-pointer rounded-xl mx-auto`}
    >
      <div className="flex justify-between w-full items-center">
        ...
        <div className="flex items-start">
          <img
            src="https://logos-world.net/wp-content/uploads/2022/05/Daraz-Logo-700x394.png"
            style={{ width: "150px", objectFit: "contain" }}
            alt=""
          />
        </div>
